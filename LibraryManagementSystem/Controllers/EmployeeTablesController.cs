...
namespace LibraryManagementSystem.Controllers
{
    public class EmployeeTablesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var employeeTables = db.EmployeeTables.Include(e => e.DepartmentTable).Include(e => e.Designation_Table);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.DepartmentID = new SelectList(db.DepartmentTables, "DepatmentID", "Name");
            ViewBag.DesignationID = new SelectList(db.Designation_Tables, "DesignationID", "Name");
            return View();
        }
        ...
        public ActionResult Create(EmployeeTable employeeTable)
        {
            ...
            ViewBag.DepartmentID = new SelectList(db.DepartmentTables, "DepatmentID", "Name", employeeTable.DepartmentID);
            ViewBag.DesignationID = new SelectList(db.Designation_Tables, "DesignationID", "Name", employeeTable.DesignationID);
            return View(employeeTable);
        }
